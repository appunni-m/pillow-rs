...
pub fn load_ref_2k() -> Image {
    ...
    Image::open_path(&path.to_string_lossy()).expect("Failed to load ref_2k.jpg")
}

/// Load ref_1k.png as an Image (1024x1024 RGBA)
pub fn load_ref_1k() -> Image {
    let path = ref_images_dir().join("ref_1k.png");
    Image::open_path(&path.to_string_lossy()).expect("Failed to load ref_1k.png")
}
...
pub fn load_ref_grayscale() -> Image {
    ...
    Image::open_path(&path.to_string_lossy()).expect("Failed to load ref_grayscale.png")
}
