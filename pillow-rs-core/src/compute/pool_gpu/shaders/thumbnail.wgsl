// Thumbnail: bilinear resize to fit within target box preserving aspect ratio.
// Output dimensions = dst_w x dst_h (computed on CPU: scale = min(tw/sw, th/sh)).
// Same PIL pixel-centered bilinear sampling as resize_bilinear.wgsl.
