...
pub use handles::{
    ...
    FT_Get_Advances, FT_Get_BDF_Property, FT_Get_CMap_Format, FT_Get_CMap_Language_ID,
    FT_Get_Char_Index, FT_Get_Charmap_Index, FT_Get_Default_Named_Instance, FT_Get_FSType_Flags,
    ...
    FT_Get_Outline_Glyph, FT_Get_PFR_Kerning, FT_Get_Postscript_Name, FT_Get_Sfnt_LangTag,
    ...
    FT_Outline_Glyph_CBox, FT_Outline_GlyphSlot_With_Advance, FT_Outline_Render,
    ...
    FT_Palette_Set_Foreground_Color, FT_Property_Get, FT_Property_Get_IncreaseXHeight,
    FT_Property_Set, FT_Property_Set_IncreaseXHeight, FT_Reference_Face, FT_Reference_Library,
    FT_Render_Glyph, FT_Request_Size, FT_RoundFix, FT_Select_Charmap, FT_Select_Size,
    FT_Set_Char_Size, FT_Set_Charmap, FT_Set_Debug_Hook, FT_Set_Default_Properties,
