...
pub use handles::{
    ...
    FT_Set_Default_Properties, FT_Set_Default_Properties_From_Env, FT_Set_Named_Instance,
    FT_Set_Pixel_Sizes, FT_Set_Transform, FT_Set_Var_Design_Coordinates, FT_Sfnt_Table_Info,
    FT_Sin, FT_Stroker, FT_Stroker_Done, FT_Stroker_Rewind, FT_Stroker_Set, FT_Tan,
