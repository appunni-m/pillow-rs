...
pub use handles::{
    ...
    FT_Stream_OpenBzip2, FT_Stream_OpenGzip, FT_Stroker, FT_Stroker_BeginSubPath, FT_Stroker_Done,
    FT_Stroker_Export, FT_Stroker_ExportBorder, FT_Stroker_GetBorderCounts, FT_Stroker_GetCounts,
    FT_Stroker_LineTo, FT_Stroker_New, FT_Stroker_Rewind, FT_Stroker_Set, FT_Tan,
