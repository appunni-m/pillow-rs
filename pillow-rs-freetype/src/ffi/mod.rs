...
pub use handles::{
    FT_Activate_Size, FT_Angle_Diff, FT_Atan2, FT_Bitmap_Copy, FT_Bitmap_Embolden, FT_Bitmap_Init,
    ...
    FT_Get_CMap_Language_ID, FT_Get_Char_Index, FT_Get_Charmap_Index, FT_Get_FSType_Flags,
    FT_Get_First_Char, FT_Get_Font_Format, FT_Get_Gasp, FT_Get_Glyph_Name, FT_Get_Kerning,
    ...
    FT_Get_Transform, FT_Get_TrueType_Engine_Type, FT_Get_X11_Font_Format, FT_GlyphSlot,
    FT_GlyphSlot_AdjustWeight, FT_GlyphSlot_Embolden, FT_GlyphSlot_Oblique, FT_GlyphSlot_Slant,
    FT_Init_FreeType, FT_Library, FT_Library_SetLcdFilter, FT_Library_SetLcdFilterWeights,
    FT_Library_SetLcdGeometry, FT_Library_Version, FT_Load_Char, FT_Load_Glyph, FT_Load_Sfnt_Table,
    FT_Matrix_Invert, FT_Matrix_Multiply, FT_MulDiv, FT_MulFix, FT_New_Face, FT_New_Memory_Face,
    FT_New_Size, FT_OpenType_Free, FT_OpenType_Validate, FT_Outline_Get_Bitmap,
    FT_Outline_Get_CBox, FT_Outline_Get_Orientation, FT_Reference_Face, FT_Render_Glyph,
    FT_Request_Size, FT_RoundFix, FT_Select_Charmap, FT_Select_Size, FT_Set_Char_Size,
    FT_Set_Charmap, FT_Set_Named_Instance, FT_Set_Pixel_Sizes, FT_Set_Transform,
