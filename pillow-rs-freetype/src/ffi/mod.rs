...
pub use handles::{
    ...
    FT_Get_Color_Glyph_Paint, FT_Get_Default_Named_Instance, FT_Get_FSType_Flags,
    FT_Get_First_Char, FT_Get_Font_Format, FT_Get_Gasp, FT_Get_Glyph, FT_Get_Glyph_Name,
...
pub use handles::{
    ...
    FT_ColrV1_PaintRecord_Snapshot, FT_Empty_GlyphSlot, FT_Fvar_Named_Style_Coords,
    FT_Get_Sfnt_MaxProfile_Copy, FT_Get_Sfnt_VertHeader_Copy,
