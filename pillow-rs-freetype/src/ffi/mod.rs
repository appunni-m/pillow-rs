...
pub use handles::{
    FT_Activate_Size, FT_Add_Default_Modules, FT_Angle_Diff, FT_Atan2, FT_Attach_Stream,
    FT_Bitmap_Blend, FT_Bitmap_Convert, FT_Bitmap_Copy, FT_Bitmap_Done, FT_Bitmap_Embolden,
    FT_Bitmap_Glyph_Copy, FT_Bitmap_Init, FT_Bitmap_New, FT_Bitmap_Owned_Buffer_Bytes,
    FT_Bitmap_Set_Owned_Buffer, FT_CeilFix, FT_ClassicKern_Free, FT_ClassicKern_Validate, FT_Cos,
    FT_DivFix, FT_Done_Face, FT_Done_FreeType, FT_Done_Glyph, FT_Done_MM_Var, FT_Done_Size,
    FT_Error_String, FT_FACE_DRIVER_NAME, FT_Face, FT_Face_CheckTrueTypePatents,
    FT_Face_GetCharVariantIndex, FT_Face_GetCharVariantIsDefault, FT_Face_GetCharsOfVariant,
    FT_Face_GetVariantSelectors, FT_Face_GetVariantsOfChar, FT_Face_Properties,
    FT_Face_Properties_Get_State, FT_Face_Properties_State, FT_Face_Property,
    ...
    FT_Outline_Glyph_Copy, FT_Outline_Glyph_To_Bitmap, FT_Outline_Render,
...
pub use handles::{
    ...
    FT_Library_Module_Flags, FT_Library_Renderer_Class, FT_Library_Set_Renderer_By_Format,
    FT_Module_Requester_Service_Available, FT_New_Library_Without_Default_Modules,
    FT_Outline_GlyphSlot_With_Advance, FT_Palette_Active_Entries_Copy, FT_Palette_Data_Copy,
