...
pub use handles::{
    ...
    FT_ClassicKern_Free, FT_Cos, FT_DivFix, FT_Done_Face, FT_Done_FreeType, FT_Done_Glyph,
    FT_Done_MM_Var, FT_Done_Size, FT_Error_String, FT_Face, FT_Face_CheckTrueTypePatents,
    ...
    FT_Get_MM_Blend_Coordinates, FT_Get_MM_WeightVector, FT_Get_Multi_Master, FT_Get_Name_Index,
    ...
    FT_Get_TrueType_Engine_Type, FT_Get_Var_Blend_Coordinates, FT_Get_Var_Design_Coordinates,
    FT_Get_WinFNT_Header, FT_Get_X11_Font_Format, FT_Glyph_Copy, FT_Glyph_Get_CBox,
    FT_Glyph_To_Bitmap, FT_GlyphSlot, FT_GlyphSlot_AdjustWeight, FT_GlyphSlot_Embolden,
    FT_GlyphSlot_Oblique, FT_GlyphSlot_Own_Bitmap, FT_GlyphSlot_Slant, FT_Init_FreeType,
    ...
    FT_Palette_Select, FT_Palette_Set_Foreground_Color, FT_Property_Get, FT_Property_Set,
    FT_Reference_Face, FT_Render_Glyph, FT_Request_Size, FT_RoundFix, FT_Select_Charmap,
    FT_Select_Size, FT_Set_Char_Size, FT_Set_Charmap, FT_Set_Debug_Hook, FT_Set_Default_Properties,
    FT_Set_Default_Properties_From_Env, FT_Set_MM_Blend_Coordinates, FT_Set_MM_WeightVector,
    FT_Set_Named_Instance, FT_Set_Pixel_Sizes, FT_Set_Transform, FT_Set_Var_Blend_Coordinates,
    FT_Set_Var_Design_Coordinates, FT_Sfnt_Table_Info, FT_Sin, FT_Stroker, FT_Stroker_Done,
