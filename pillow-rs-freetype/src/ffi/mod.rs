...
pub use handles::{
    ...
    FT_Done_FreeType, FT_Done_Size, FT_Face, FT_Face_Charmap, FT_Face_Charmap_Count,
    FT_Face_Charmap_Info, FT_Face_CheckTrueTypePatents, FT_Face_Info,
    FT_Face_Active_Charmap_Index, FT_Face_SetUnpatentedHinting, FT_FloorFix, FT_Get_Advance,
    FT_Get_Advances, FT_Get_CMap_Format, FT_Get_CMap_Language_ID, FT_Get_Char_Index,
    FT_Get_Charmap_Index, FT_Get_Charmap_Index_For_Face, FT_Get_FSType_Flags, FT_Get_First_Char,
    FT_Get_Kerning, FT_Get_Next_Char, FT_Get_Sfnt_LangTag, FT_Get_Sfnt_Name, FT_Get_Sfnt_Name_Count,
    FT_Get_Sfnt_OS2, FT_Get_Sfnt_Table, FT_Get_TrueType_Engine_Type, FT_GlyphSlot,
    ...
    FT_Library_SetLcdGeometry, FT_Library_Version, FT_Load_Char, FT_Load_Glyph,
