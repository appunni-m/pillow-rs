...
pub use handles::{
    ...
    FT_Bitmap_Convert, FT_Bitmap_Copy, FT_Bitmap_Done, FT_Bitmap_Embolden, FT_Bitmap_Glyph_Copy,
    FT_Bitmap_Init, FT_Bitmap_New, FT_Bitmap_Owned_Buffer_Bytes, FT_Bitmap_Set_Owned_Buffer,
    FT_CeilFix, FT_ClassicKern_Free, FT_ClassicKern_Validate, FT_Cos, FT_DivFix, FT_Done_Face,
    FT_Done_FreeType, FT_Done_Glyph, FT_Done_MM_Var, FT_Done_Size, FT_Error_String,
    FT_FACE_DRIVER_NAME, FT_Face, FT_Face_CheckTrueTypePatents, FT_Face_GetCharVariantIndex,
    FT_Face_GetCharVariantIsDefault, FT_Face_GetCharsOfVariant, FT_Face_GetVariantSelectors,
    FT_Face_GetVariantsOfChar, FT_Face_Properties, FT_Face_Properties_Get_State,
    FT_Face_Properties_State, FT_Face_Property, FT_Face_Property_Value,
    FT_Face_SetUnpatentedHinting, FT_FloorFix, FT_Get_Advance, FT_Get_Advances,
    FT_Get_BDF_Charset_ID, FT_Get_BDF_Property, FT_Get_Bitmap_Glyph, FT_Get_CID_From_Glyph_Index,
    FT_Get_CID_Is_Internally_CID_Keyed, FT_Get_CID_Registry_Ordering_Supplement,
    FT_Get_CMap_Format, FT_Get_CMap_Language_ID, FT_Get_Char_Index, FT_Get_Charmap_Index,
    FT_Get_Color_Glyph_ClipBox, FT_Get_Color_Glyph_Layer, FT_Get_Color_Glyph_Paint,
    FT_Get_Colorline_Stops, FT_Get_Default_Named_Instance, FT_Get_FSType_Flags, FT_Get_First_Char,
    FT_Get_Font_Format, FT_Get_Gasp, FT_Get_Glyph, FT_Get_Glyph_Name, FT_Get_Kerning,
    FT_Get_MM_Blend_Coordinates, FT_Get_MM_Var, FT_Get_MM_WeightVector, FT_Get_Module_Interface,
    FT_Get_Multi_Master, FT_Get_Name_Index, FT_Get_Next_Char, FT_Get_Outline_Glyph,
    FT_Get_PFR_Kerning, FT_Get_PS_Font_Info, FT_Get_PS_Font_Private, FT_Get_PS_Font_Value,
    FT_Get_Paint, FT_Get_Paint_Layers, FT_Get_Postscript_Name, FT_Get_Sfnt_LangTag,
    ...
    FT_GlyphSlot_Oblique, FT_GlyphSlot_Own_Bitmap, FT_GlyphSlot_Slant, FT_Gzip_Stream_Close,
    FT_Gzip_Stream_Read, FT_Gzip_Uncompress, FT_Has_PS_Glyph_Names, FT_Init_FreeType, FT_Library,
    ...
    FT_New_Size, FT_Open_External_Stream_Face_With_Name_Options, FT_Open_Face_Name_Options,
    FT_OpenType_Free, FT_OpenType_Validate, FT_Outline_Check, FT_Outline_Copy,
    ...
    FT_Outline_Glyph_Copy, FT_Outline_GlyphSlot_With_Advance, FT_Outline_Render,
    ...
    FT_Stream_OpenGzip, FT_Stroker, FT_Stroker_Done, FT_Stroker_Export, FT_Stroker_ExportBorder,
    FT_Stroker_New, FT_Stroker_Rewind, FT_Stroker_Set, FT_Tan, FT_TrueTypeGX_Free,
    FT_Vector_From_Polar, FT_Vector_Length, FT_Vector_Polarize, FT_Vector_Rotate,
    FT_Vector_Transform, FT_Vector_Unit, FTC_Node_Unref, FTOutlineDecomposeEvent,
...
pub use handles::{
    ...
    FT_Library_Module_Flags, FT_Library_Renderer_Class, FT_Module_Requester_Service_Available,
