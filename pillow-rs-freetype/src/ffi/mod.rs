...
pub use handles::{
    ...
    FT_Get_TrueType_Engine_Type, FT_Get_X11_Font_Format, FT_GlyphSlot, FT_GlyphSlot_AdjustWeight,
    ...
    FT_New_Size, FT_OpenType_Free, FT_OpenType_Validate, FT_Outline_Check, FT_Outline_Copy,
