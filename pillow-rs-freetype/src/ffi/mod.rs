...
pub use handles::{
    ...
    FT_Get_TrueType_Engine_Type, FT_Get_WinFNT_Header, FT_Get_X11_Font_Format, FT_GlyphSlot,
    ...
    FT_Library_Version, FT_List_Add, FT_List_Find_Node_Matches, FT_List_Insert,
    ...
    FT_Open_Face_Name_Options, FT_OpenType_Free, FT_OpenType_Validate, FT_Outline_Check,
    FT_Outline_Copy, FT_Outline_Decompose_Trace, FT_Outline_Embolden, FT_Outline_EmboldenXY,
    FT_Outline_Get_Bitmap, FT_Outline_Get_CBox, FT_Outline_Get_Orientation,
    FT_Outline_GetInsideBorder, FT_Outline_GetOutsideBorder, FT_Outline_Render,
