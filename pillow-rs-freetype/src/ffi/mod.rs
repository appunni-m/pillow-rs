...
pub use handles::{
    ...
    FT_Get_BDF_Charset_ID, FT_Get_BDF_Property, FT_Get_Bitmap_Glyph, FT_Get_CMap_Format,
    FT_Get_CMap_Language_ID, FT_Get_Char_Index, FT_Get_Charmap_Index, FT_Get_Color_Glyph_ClipBox,
    ...
    FT_Get_Name_Index, FT_Get_Next_Char, FT_Get_Outline_Glyph, FT_Get_PFR_Kerning,
    FT_Get_PS_Font_Info, FT_Get_PS_Font_Private, FT_Get_PS_Font_Value, FT_Get_Paint,
    FT_Get_Paint_Layers, FT_Get_Postscript_Name, FT_Get_Sfnt_LangTag, FT_Get_Sfnt_Name,
    ...
    FT_Gzip_Uncompress, FT_Has_PS_Glyph_Names, FT_Init_FreeType, FT_Library,
