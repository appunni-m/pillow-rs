...
pub use handles::{
    ...
    FT_Get_MM_Blend_Coordinates, FT_Get_Name_Index, FT_Get_Next_Char, FT_Get_Postscript_Name,
    FT_Get_Sfnt_LangTag, FT_Get_Sfnt_Name, FT_Get_Sfnt_Name_Count, FT_Get_Sfnt_Table,
    FT_Get_SubGlyph_Info, FT_Get_Transform, FT_Get_TrueType_Engine_Type,
