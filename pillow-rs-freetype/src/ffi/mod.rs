...
pub use handles::{
    ...
    FT_Get_TrueType_Engine_Type, FT_GlyphSlot, FT_GlyphSlot_AdjustWeight, FT_GlyphSlot_Embolden,
    FT_GlyphSlot_Oblique, FT_GlyphSlot_Slant, FT_Init_FreeType, FT_Library,
