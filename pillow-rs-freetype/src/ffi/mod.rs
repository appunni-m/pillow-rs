...
pub use handles::{
    ...
    FT_Get_MM_Blend_Coordinates, FT_Get_MM_Var, FT_Get_MM_WeightVector, FT_Get_Multi_Master,
    ...
    FT_Get_Transform, FT_Get_TrueType_Engine_Type, FT_Get_Var_Blend_Coordinates,
    FT_Get_Var_Design_Coordinates, FT_Get_WinFNT_Header, FT_Get_X11_Font_Format, FT_Glyph_Copy,
    FT_Glyph_Get_CBox, FT_Glyph_To_Bitmap, FT_GlyphSlot, FT_GlyphSlot_AdjustWeight,
    ...
    FT_List_Finalize_Node, FT_List_Find_Node_Matches, FT_List_Insert, FT_List_Iterate_Next,
    FT_List_Remove, FT_List_Up, FT_Load_Char, FT_Load_Glyph, FT_Load_Sfnt_Table, FT_Matrix_Invert,
    FT_Matrix_Multiply, FT_MulDiv, FT_MulFix, FT_New_Face, FT_New_Memory_Face,
    FT_New_Memory_Face_With_Name_Options, FT_New_Size, FT_Open_Face_Name_Options, FT_OpenType_Free,
    ...
    FT_Outline_GetOutsideBorder, FT_Outline_Render, FT_Outline_Render_Direct_Spans,
    ...
    FT_Property_Set, FT_Reference_Face, FT_Render_Glyph, FT_Request_Size, FT_RoundFix,
