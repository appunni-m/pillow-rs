...
pub use handles::{
    ...
    FT_Outline_Glyph_To_Bitmap, FT_Outline_Render, FT_Outline_Render_Direct_Spans,
    ...
    FT_Stream_OpenBzip2, FT_Stream_OpenGzip, FT_Stroker, FT_Stroker_BeginSubPath,
    FT_Stroker_ConicTo, FT_Stroker_CubicTo, FT_Stroker_Done, FT_Stroker_EndSubPath,
    FT_Stroker_Export, FT_Stroker_ExportBorder, FT_Stroker_GetBorderCounts, FT_Stroker_GetCounts,
    FT_Stroker_LineTo, FT_Stroker_New, FT_Stroker_ParseOutline, FT_Stroker_Rewind, FT_Stroker_Set,
    FT_Tan, FT_TrueTypeGX_Free, FT_Vector_From_Polar, FT_Vector_Length, FT_Vector_Polarize,
