...
pub use handles::{
    ...
    FT_Bitmap_New, FT_Bitmap_Owned_Buffer_Bytes, FT_Bitmap_Set_Owned_Buffer, FT_CeilFix,
    FT_ClassicKern_Free, FT_ClassicKern_Validate, FT_Cos, FT_DivFix, FT_Done_Face,
    ...
    FT_Get_BDF_Charset_ID, FT_Get_BDF_Property, FT_Get_CMap_Format, FT_Get_CMap_Language_ID,
    FT_Get_Char_Index, FT_Get_Charmap_Index, FT_Get_Color_Glyph_Layer, FT_Get_Color_Glyph_Paint,
    ...
    FT_Gzip_Stream_Read, FT_Gzip_Uncompress, FT_Init_FreeType, FT_Library, FT_Library_SetLcdFilter,
    FT_Library_SetLcdFilterWeights, FT_Library_SetLcdGeometry, FT_Library_Version, FT_List_Add,
    FT_List_Finalize_Clear, FT_List_Finalize_Node, FT_List_Find_Node_Matches, FT_List_Insert,
    FT_List_Iterate_Next, FT_List_Remove, FT_List_Up, FT_Load_Char, FT_Load_Glyph,
    FT_Load_Sfnt_Table, FT_Matrix_Invert, FT_Matrix_Multiply, FT_MulDiv, FT_MulFix, FT_New_Face,
    ...
    FT_Outline_GetOutsideBorder, FT_Outline_Glyph_CBox, FT_Outline_GlyphSlot_With_Advance,
...
pub use handles::{
    ...
    FT_Empty_GlyphSlot, FT_Fvar_Named_Style_Coords, FT_Get_Sfnt_MaxProfile_Copy,
    FT_Get_Sfnt_VertHeader_Copy, FT_Glyph_To_Script_Map_Sample_For_Test,
