...
pub use handles::{
    ...
    FT_Outline_Get_Orientation, FT_Outline_Render, FT_Outline_Render_Direct_Spans,
    FT_Outline_Render_Error_Output, FT_Outline_Reverse, FT_Outline_Transform, FT_Reference_Face,
