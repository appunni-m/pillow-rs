...
pub use handles::{
    ...
    FT_Get_MM_Blend_Coordinates, FT_Get_Multi_Master, FT_Get_Name_Index, FT_Get_Next_Char,
    ...
    FT_Get_X11_Font_Format, FT_Glyph_Copy, FT_Glyph_Get_CBox, FT_Glyph_To_Bitmap, FT_GlyphSlot,
    ...
    FT_Set_Default_Properties_From_Env, FT_Set_MM_Blend_Coordinates, FT_Set_Named_Instance,
