...
pub use handles::{
    ...
    FT_OpenType_Free, FT_OpenType_Validate, FT_Outline_Check, FT_Outline_Decompose_Trace,
    FT_Outline_Get_Bitmap, FT_Outline_Get_CBox, FT_Outline_Get_Orientation, FT_Outline_Render,
