...
pub use handles::{
    ...
    FT_OpenType_Free, FT_OpenType_Validate, FT_Reference_Face, FT_Render_Glyph, FT_Request_Size,
    FT_RoundFix, FT_Select_Charmap, FT_Select_Size, FT_Set_Char_Size, FT_Set_Charmap,
    FT_Set_Named_Instance, FT_Set_Pixel_Sizes, FT_Set_Transform, FT_Sfnt_Table_Count,
    FT_Sfnt_Table_Info, FT_Sin, FT_Size_Metrics, FT_Tan, FT_Vector_From_Polar, FT_Vector_Length,
