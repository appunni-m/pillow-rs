...
pub use handles::{
    ...
    FT_Get_Sfnt_Table, FT_Get_SubGlyph_Info, FT_Get_Transform, FT_Get_TrueType_Engine_Type,
    FT_Get_Var_Axis_Flags, FT_Get_Var_Blend_Coordinates, FT_Get_Var_Design_Coordinates,
    FT_Get_WinFNT_Header, FT_Get_X11_Font_Format, FT_Glyph_Copy, FT_Glyph_Get_CBox,
    FT_Glyph_To_Bitmap, FT_Glyph_Transform_Outline, FT_GlyphSlot, FT_GlyphSlot_AdjustWeight,
    FT_GlyphSlot_Embolden, FT_GlyphSlot_Oblique, FT_GlyphSlot_Own_Bitmap, FT_GlyphSlot_Slant,
    FT_Gzip_Stream_Close, FT_Gzip_Stream_Read, FT_Gzip_Uncompress, FT_Init_FreeType, FT_Library,
