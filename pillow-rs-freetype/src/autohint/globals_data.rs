...
/// Get the ordered standard-character candidates for stem width detection.
/// Matches the complete FreeType 2.14.3 `afscript.h` strings.
pub fn standard_chars_for_script(tag: &str) -> &'static [char] {
    match tag {
        "adlm" => &['\u{1E90C}', '\u{1E92E}'],
        "arab" => &['\u{0644}', '\u{062D}', '\u{0640}'],
        "armn" => &['\u{057D}', '\u{054D}'],
        "avst" => &['\u{10B1A}'],
        "bamu" => &['\u{A6C1}', '\u{A6EF}'],
        "beng" => &['\u{09E6}', '\u{09EA}'],
        "buhd" => &['\u{174B}', '\u{174F}'],
        "cakm" => &['\u{11124}', '\u{11109}', '\u{1111B}'],
        "cans" => &['\u{144C}', '\u{14DA}'],
        "cari" => &['\u{102AB}', '\u{102C9}'],
        "cher" => &['\u{13A4}', '\u{13C5}', '\u{AB95}'],
        "copt" => &['\u{2C9E}', '\u{2C9F}'],
        "cprt" => &['\u{10805}', '\u{10823}'],
        "cyrl" => &['\u{043E}', '\u{041E}'],
        "deva" => &['\u{0920}', '\u{0935}', '\u{091F}'],
        "dsrt" => &['\u{10404}', '\u{1042C}'],
        "ethi" => &['\u{12D0}'],
        "geok" => &['\u{10B6}', '\u{10B1}', '\u{2D19}'],
        "geor" => &['\u{10D8}', '\u{10D4}', '\u{10D0}', '\u{1CBF}'],
        "glag" => &['\u{2C15}', '\u{2C45}'],
        "goth" => &['\u{10334}', '\u{1033E}', '\u{10343}'],
        "grek" => &['\u{03BF}', '\u{039F}'],
        "gujr" => &['\u{0A9F}', '\u{0AE6}'],
        "guru" => &['\u{0A20}', '\u{0A30}', '\u{0A66}'],
        "hani" => &['\u{7530}', '\u{56D7}'],
        "hebr" => &['\u{05DD}'],
        "kali" => &['\u{A90D}', '\u{A900}'],
        "khmr" => &['\u{17E0}'],
        ...
        "lao" => &['\u{0ED0}'],
        "latb" => &['\u{2092}', '\u{2080}'],
        "latn" => &['\u{006F}', '\u{004F}', '\u{0030}'],
        "latp" => &['\u{1D52}', '\u{1D3C}', '\u{2070}'],
        "limb" => &['\u{006F}'],
        "lisu" => &['\u{A4F3}'],
        "medf" => &['\u{16E61}', '\u{16E5B}', '\u{16E6F}'],
        "mlym" => &['\u{0D20}', '\u{0D31}'],
        "mong" => &['\u{1842}', '\u{182A}'],
        "mymr" => &['\u{101D}', '\u{1004}', '\u{1002}'],
        "nkoo" => &['\u{07CB}', '\u{07C0}'],
        "none" => &[],
        "olck" => &['\u{1C5B}'],
        "orkh" => &['\u{10C17}'],
        "orya" => &['\u{006F}'],
        "osge" => &['\u{104C2}', '\u{104EA}'],
        "osma" => &['\u{10486}', '\u{104A0}'],
        "rohg" => &['\u{10D30}'],
        "saur" => &['\u{A89D}', '\u{A8D0}'],
        "shaw" => &['\u{10474}'],
        "sinh" => &['\u{0DA7}'],
        ...
        "telu" => &['\u{0C66}', '\u{0C67}'],
        "tfng" => &['\u{2D54}'],
        "thai" => &['\u{0E32}', '\u{0E45}', '\u{0E50}'],
        "tibt" => &['\u{006F}'],
        "vaii" => &['\u{A613}', '\u{A59C}', '\u{A5B4}'],
        _ => &[],
    }
}

/// Get the first standard character for stem width detection for a script tag.
/// Falls back to `'o'` for scripts without a candidate, preserving the public
/// helper's original behavior.
pub fn standard_char_for_script(tag: &str) -> char {
    standard_chars_for_script(tag)
        .first()
        .copied()
        .unwrap_or('o')
}
