...
pub fn scale_glyph(
    ...
    // Bytecode VM (crate::tt::hinter) is implemented but disabled.
    // Produces regressions without full opcode coverage and prep program
    // execution. Re-enable when Phase 3 (IUP + prep + remaining opcodes)
    // is complete.
