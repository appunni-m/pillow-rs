...
| `917707b1c697` | 2.3 | 1 | `fonts/autohint/cjk-coverage.ttf` | source-backed glyf, 20 glyphs, 28 mappings, vertical metrics, CJK geometry plus Latin adjustment, blue-zone, and serif topologies |
...
27. One 3.2 KiB hinter control font combines compact IDEF and FDEF bodies,
    present-empty `prep`, a valid CVT, and seventeen focused program glyphs.
    ...
    multiplying sizes or flags. Its
