...
| `0b39dfb1fe92` | 8.4 | 1 | `fonts/autohint/script-coverage.ttf` | source-backed glyf, 76 glyphs, 181 Unicode mappings, one compact glyph per autohint script tag plus standard-character aliases, Latin double-top, tilde branch, accent-separation, top2-centering, disjoint-accent, and serif-m probes |
