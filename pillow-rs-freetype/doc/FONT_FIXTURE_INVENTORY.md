...
| `90145df4f21c` | 2.2 | 1 | `fonts/autohint/cjk-coverage.ttf` | source-backed glyf, 17 glyphs, 27 mappings, vertical metrics, CJK geometry plus Latin adjustment topologies |
