...
| `6b0d788b9330` | 4.5 | 1 | `fonts/glyf/hinter-empty-glyph-iup.ttf` | derived source-backed TrueType control whose valid zero-contour `glyf` record retains an instruction body; owns C-compatible zero-point simple-glyph parsing while confirming the public empty-glyph loader shortcut ignores the body before IUP |
