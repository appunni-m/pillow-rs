...
| `89b121b11d1b` | 8.1 | 1 | `fonts/autohint/script-coverage.ttf` | source-backed glyf, 75 glyphs, 180 Unicode mappings, one compact glyph per autohint script tag plus standard-character aliases, Latin double-top, tilde branch, accent-separation, top2-centering, and serif-m probes |
...
| `script-coverage.ttf` | all generated `SCRIPT_PROBES` codepoints from `scripts/build_autohint_script_fixtures.py` plus Latin branch probes U+01D5, U+00F1, U+1E4D, U+00E3, U+00D1, U+1E1B, U+1E1A, U+1E75, U+1EAA, U+1EB4, U+1EAD, U+01D7, U+0244, and U+0245 | 17, 20 | explicit `FT_LOAD_FORCE_AUTOHINT` script-selection rows for compact script glyphs plus Latin double-top, top/top2/bottom tilde, top-vs-second-top tilde, secondary top-tilde centering, top/bottom accent separation, serif-m symmetry, serif intermediate-overlap, and vertical-cusp target-mono topology probes; this proves each selected script tag and the added Latin topology branches through real Rust/C ABI/WASM parity without an implicit script matrix |
...
30. The compact autohint script fixture provides one glyph per script tag plus
    ...
    autohint branch fixtures such as `latin-blue-edge-cases.ttf`. It is generated by
