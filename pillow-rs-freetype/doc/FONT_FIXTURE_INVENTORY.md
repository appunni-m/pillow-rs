...
| `script-coverage.ttf` | U+1E90C, U+0627, U+0531, U+0987, U+0A07, U+05D1, U+1781, U+0C87, U+2080, U+2070, U+0D12, U+1833, U+0E1A | 20 | explicit `FT_LOAD_FORCE_AUTOHINT` script-selection rows for Adlam, Arabic, Armenian, Bengali, Gurmukhi, Hebrew, Khmer, Kannada, Latin sub/superscript, Malayalam, Mongolian, and Thai standard-character paths |
...
30. One compact 5.5 KiB autohint script fixture provides one glyph per script
    ...
    `make font-fixture-autohint-scripts`. Current public inputs select 13 rows
