...
| 2026-07-11 | API monochrome target flag combinations | 81 unique hashes | 0 | 6,466 | 6,465 / 6,465 | 1 | 13,271 / 16,301 lines; 19,130 / 23,292 regions; 3,221 / 4,148 branches | three explicit `FT_Load_Glyph` render variants cover `api.rs` monochrome short-circuit outcomes for LCD, LCD_V, and LIGHT targets; exact Rust/C/WASM parity remains green |
