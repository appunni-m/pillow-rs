...
|---|---:|---|
| Real C/Rust/C-ABI/WASM parity route | 3,244 | Use these rows for structural coverage evidence. |
...
| Shape-incomplete fallback | 9 | Convert to complete explicit variants or mark invalid/pending. |
...
The first R0 closure bucket is the 9 shape-incomplete rows because these are
