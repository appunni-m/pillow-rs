...
| 2026-07-11 | Latin adjustment aliases | 81 unique hashes | 0 | 6,465 | 6,464 / 6,464 | 1 | 13,274 / 16,301 lines; 19,136 / 23,292 regions; 3,221 / 4,148 branches | two cmap aliases in the compact source-backed CJK/autohint font add public `FT_LOAD_FORCE_AUTOHINT` rows for no-height-check and small-blue-ignore adjustment behavior; `latin.rs` gains 3 lines, 6 regions, and 3 branches with exact Rust/C/WASM parity |
