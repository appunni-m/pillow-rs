...
|---|---:|
| Logical public API cases | 4,166 |
| Concrete explicit cases | 6,858 |
| Runnable parity comparisons | 6,855 / 6,855 |
| Pending cases | 3 |
| Covered Rust lines | 17,839 / 19,838 (89.9234%) |
| Rust region coverage | 25,712 / 28,583 (89.9556%) |
| Rust branch/condition coverage | 4,215 / 4,917 (85.7230%) |
| Rust function coverage | 1,149 / 1,332 (86.2613%) |
| Route audit split | real-parity 3,573; generic-fallback 884; generic-error-fallback 139; null-error-fallback 7; raw-slot-null-validation 4; pending-core 5; shape-incomplete-fallback 0 |
