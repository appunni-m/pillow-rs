...
| 2026-07-11 | Render mono low-precision box | 81 unique hashes | 0 | 6,466 | 6,465 / 6,465 | 1 | 13,271 / 16,301 lines; 19,130 / 23,292 regions; 3,219 / 4,148 branches | three narrow `FT_Bitmap` render variants extend the compact hinter-control font with collapsed mono contours and a 130 px mono box; the low-precision mono selector branch is now covered with exact Rust/C/WASM parity |
