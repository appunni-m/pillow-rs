...
|---|---:|
| Logical public API cases | 4,166 |
| Concrete explicit cases | 6,856 |
| Runnable parity comparisons | 6,853 / 6,853 |
| Pending cases | 3 |
...
| Route audit split | real-parity 3,562; generic-fallback 893; generic-error-fallback 139; null-error-fallback 7; raw-slot-null-validation 4; pending-core 5; shape-incomplete-fallback 0 |
