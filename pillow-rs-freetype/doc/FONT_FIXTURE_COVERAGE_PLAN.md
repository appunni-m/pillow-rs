...
| 2026-07-11 | CJK force-autohint mono render load | 81 unique hashes | 0 | 6,464 | 6,463 / 6,463 | 1 | 13,276 / 16,301 lines; 19,137 / 23,292 regions; 3,220 / 4,148 branches | one explicit `FT_Load_Char` variant reuses `cjk-coverage.ttf` U+7530 with `FT_LOAD_FORCE_AUTOHINT | FT_LOAD_RENDER | FT_LOAD_TARGET_MONO`; exact Rust/C/WASM parity remains green and CJK hint/render target handling gains 5 lines, 7 regions, and 2 branches |
