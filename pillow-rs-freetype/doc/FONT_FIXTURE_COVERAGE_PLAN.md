...
| 2026-07-11 | TrueType interpreter branch-edge glyph | 81 unique hashes | 0 | 6,464 | 6,463 / 6,463 | 1 | 13,283 / 16,301 lines; 19,149 / 23,292 regions; 3,224 / 4,148 branches | one source-backed `hinter-control-matrix.ttf` glyph adds zero-length vector, invalid stack-index fallback, taken JROF, NROUND, invalid SHC contour, and empty-twilight SHZ coverage through `FT_Load_Glyph`; `tt/hinter/exec.rs` rises from 1,210/1,340 to 1,222/1,340 lines, 2,444/2,901 to 2,463/2,901 regions, and 291/410 to 297/410 branches |
