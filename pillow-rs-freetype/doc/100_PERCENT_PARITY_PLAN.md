...
| `no_hinting_matrix.json` | `10029/11086` | unfinished no-hinting render parity |
| `render_mono_matrix.json` | `915/11086` | unfinished monochrome render parity |
| `render_lcd_matrix.json` | `215/11086` | unfinished LCD render parity |
| `metrics_only_matrix.json` | `13/11086` | unfinished metrics parity |
| `outline_cbox_matrix.json` | `7/11086` | unfinished outline CBox/bbox parity |
...
1. Promote `metrics_only` from executed `13/11086` baseline to exact.
2. Promote `outline_cbox` from executed `7/11086` baseline to exact.
3. Promote `no_hinting` from executed `10029/11086` broad baseline to exact.
4. Promote `render_mono` from executed `915/11086` baseline to exact.
5. Promote `render_lcd` from executed `215/11086` baseline to exact.
...
- `harness_contract.rs` keeps each family classified as exact, incomplete executed baseline, small executed baseline, or explicit unexecuted debt.
