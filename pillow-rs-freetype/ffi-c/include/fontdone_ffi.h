...
typedef int64_t FT_Fixed;
typedef int64_t FT_F26Dot6;
typedef uint16_t FT_UShort;
typedef int32_t FT_Render_Mode;
typedef int32_t FT_Pixel_Mode;
typedef int32_t FT_Glyph_Format;
...
void* fontdone_malloc(size_t size);
void fontdone_free(void* ptr, size_t size);
...
FT_Size_Metrics FT_Size_Metrics_Get(FT_Face face);
