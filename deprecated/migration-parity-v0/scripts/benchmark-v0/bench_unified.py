...
Usage:
  python scripts/bench/bench_unified.py --target rspil   # pillow-rs benchmarks
  python scripts/bench/bench_unified.py --target pil     # Pillow baseline
  python scripts/bench/bench_unified.py --validate       # cross-validate hashes
"""
