...
// Internal mode 9 packs four independent native bytes per word; _pad is
// the word count, and width/height describe the dispatch rectangle.
...
fn main(@builtin(global_invocation_id) gid: vec3<u32>) {
    ...
    let out_a_raw = 255u - ((255u - aa) * (255u - ba) / 255u);
