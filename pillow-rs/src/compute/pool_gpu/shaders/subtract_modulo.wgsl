// SubtractModulo: (a - b + 256) % 256 per channel
...
fn main(@builtin(global_invocation_id) gid: vec3<u32>) {
    ...
    let out_r = (ar + 256u - br) % 256u;
    let out_g_raw = (ag + 256u - bg) % 256u;
    let out_b_raw = (ab + 256u - bb) % 256u;
    let out_a_raw = (aa + 256u - ba) % 256u;
