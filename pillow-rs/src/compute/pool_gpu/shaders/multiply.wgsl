// Multiply: (a * b) / 255 per channel
// Mode-aware: only processes channels present in the image mode.
// Mode codes: 0=L, 1=LA, 2=RGB, 3=RGBA
// Internal mode 9 packs four independent native samples per word; _pad is
// the word count, and width/height describe a dispatch rectangle.
