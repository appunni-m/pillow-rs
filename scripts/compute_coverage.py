...
def infer_function_from_test(test: dict) -> str | None:
    ...
    func_name_map = {
        ...
        # Image IO
        "test_save_png_roundtrip": "Image.save",
        "test_save_jpeg_roundtrip": "Image.save",
        "test_open_bytes": "Image.open",
        "test_thumbnail_parity": "Image.thumbnail",
        "test_close_no_error": "Image.close",
        "test_verify_no_error": "Image.verify",
        "test_seek_tell": "Image.seek",
        "test_load_returns": "Image.load",
        # Image advanced
        "test_alpha_composite_works": "Image.alpha_composite",
        "test_point_lut_parity": "Image.point",
        "test_effect_spread_works": "Image.effect_spread",
        "test_quantize_parity": "Image.quantize",
        "test_entropy_works": "Image.entropy",
        "test_getcolors_works": "Image.getcolors",
        "test_getdata_works": "Image.getdata",
        "test_getprojection_works": "Image.getprojection",
        # ImageChops advanced
        "test_add_modulo_works": "ImageChops.add_modulo",
        "test_subtract_modulo_works": "ImageChops.subtract_modulo",
        "test_constant_works": "ImageChops.constant",
        "test_blend_parity": "ImageChops.blend",
        "test_composite_works": "ImageChops.composite",
        "test_duplicate_parity": "ImageChops.duplicate",
        # ImageDraw advanced
        "test_draw_arc_works": "ImageDraw.arc",
        "test_draw_chord_works": "ImageDraw.chord",
        ...
        "TestBlend::test_blend_parity": "ImageModule.blend",
        "TestComposite::test_composite_works": "ImageModule.composite",
        # ImageOps advanced
        "test_autocontrast_works": "ImageOps.autocontrast",
        "test_contain_parity": "ImageOps.contain",
        "test_cover_parity": "ImageOps.cover",
        "test_expand_parity": "ImageOps.expand",
        "test_scale_parity": "ImageOps.scale",
        # Final additions
