...
| Live parity | Full clean-checkout run required 1,181 cases and last measured 720 pass / 461 fail / 0 infrastructure errors | RUN-001, RUN-004, RUN-006, and RUN-007 have maintained producers; behavioral failures are real target gaps, not suppressed results. RUN-008 and RUN-009 remain archive/anti-cheat follow-up work. |
