...
coverage_run_id: migration-coverage-28e16de229b24d4480922f3512495b28
...
Scoped input-only evidence covers `38` getbbox cases (run `migration-coverage-518aba699dcd454c96aa216b7eac6739`).
Rust implementation regions: `104/104` (100.0%).
Python facade statements: `1/1` (100.0%).
Component aggregate for backlog ordering: `13332/14462` (92.2%).
...
| `PIL.Image.Image.alpha_composite` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.apply_transparency` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.close` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.convert` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.copy` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.crop` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.draft` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.effect_spread` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.entropy` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.filter` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.format` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.frombytes` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.get_child_images` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.get_flattened_data` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.getbands` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.getbbox` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.getchannel` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.getcolors` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.getdata` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.getexif` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.getextrema` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.getim` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.getpalette` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.getpixel` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.getprojection` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.getxmp` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.has_transparency_data` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.height` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.histogram` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.info` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.load` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.mode` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.paste` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.point` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.putalpha` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.putdata` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.putpalette` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.putpixel` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.quantize` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.reduce` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.remap_palette` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.resize` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.rotate` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.save` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.seek` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.size` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.split` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.tell` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.thumbnail` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.tobitmap` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.tobytes` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.toqimage` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.toqpixmap` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.transform` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.transpose` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.verify` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.Image.width` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.alpha_composite` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.blend` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.composite` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.effect_mandelbrot` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.effect_noise` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.eval` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.fromarray` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.frombuffer` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.frombytes` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.linear_gradient` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.merge` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.new` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.open` | `image-core` | 13332/14462 | 92.2% |
| `PIL.Image.radial_gradient` | `image-core` | 13332/14462 | 92.2% |
...
| `image-core` | `pillow-rs/src/compute/pool_cpu/ops/geometry.rs` | 1421/1728 | 82.2% |
| `image-core` | `pillow-rs/src/image.rs` | 4823/5329 | 90.5% |
