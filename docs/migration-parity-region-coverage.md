...
coverage_run_id: migration-coverage-bc189e0e450a4d6bae7b16d9e5cbfc1d
...
Scoped input-only evidence covers `38` getbbox cases (run `migration-coverage-330cbbd2189c42179f91ce228b421821`).
