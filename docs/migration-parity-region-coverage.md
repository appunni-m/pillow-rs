...
coverage_run_id: migration-coverage-5dcfc5008218483f9555725563284dc9
...
`PIL.Image.Image.getbbox -> region coverage 3976/6940 (57.3%)`
...
| --- | --- | ---: | ---: |
| `PIL.ImageColor.getcolor` | `image-color` | 192/805 | 23.9% |
| `PIL.ImageColor.getrgb` | `image-color` | 192/805 | 23.9% |
| `PIL.ImagePalette.ImagePalette` | `image-palette` | 192/805 | 23.9% |
| `PIL.ImagePalette.ImagePalette.copy` | `image-palette` | 192/805 | 23.9% |
| `PIL.ImagePalette.ImagePalette.getcolor` | `image-palette` | 192/805 | 23.9% |
| `PIL.ImagePalette.ImagePalette.getdata` | `image-palette` | 192/805 | 23.9% |
| `PIL.ImagePalette.ImagePalette.save` | `image-palette` | 192/805 | 23.9% |
| `PIL.ImagePalette.ImagePalette.tobytes` | `image-palette` | 192/805 | 23.9% |
...
| `PIL.Image.Image.alpha_composite` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.apply_transparency` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.close` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.convert` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.copy` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.crop` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.draft` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.effect_spread` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.entropy` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.filter` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.format` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.frombytes` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.get_child_images` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.get_flattened_data` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.getbands` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.getbbox` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.getchannel` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.getcolors` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.getdata` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.getexif` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.getextrema` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.getim` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.getpalette` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.getpixel` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.getprojection` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.getxmp` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.height` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.histogram` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.info` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.load` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.mode` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.paste` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.point` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.putalpha` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.putdata` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.putpalette` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.putpixel` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.quantize` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.reduce` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.remap_palette` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.resize` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.rotate` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.save` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.seek` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.show` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.size` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.split` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.tell` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.thumbnail` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.tobitmap` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.tobytes` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.toqimage` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.toqpixmap` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.transform` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.transpose` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.verify` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.Image.width` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.alpha_composite` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.blend` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.composite` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.effect_mandelbrot` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.effect_noise` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.eval` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.fromarray` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.frombuffer` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.frombytes` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.linear_gradient` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.merge` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.new` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.open` | `image-core` | 3976/6940 | 57.3% |
| `PIL.Image.radial_gradient` | `image-core` | 3976/6940 | 57.3% |
...
| --- | --- | ---: | ---: |
| `image-color` | `pillow-rs/src/color.rs` | 192/805 | 23.9% |
...
| `image-core` | `pillow-rs/src/ops/convert.rs` | 267/487 | 54.8% |
...
| `image-palette` | `pillow-rs/src/color.rs` | 192/805 | 23.9% |
