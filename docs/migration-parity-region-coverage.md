...
coverage_run_id: migration-coverage-1a27b23aae83490aa17f29663782b5ec
...
Scoped input-only evidence covers `38` getbbox cases (run `migration-coverage-82644c4ccbc3479eb6add618ffea4864`).
