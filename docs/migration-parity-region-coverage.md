...
coverage_run_id: migration-coverage-f9c7063a8623404e8290745452117322
...
Scoped input-only evidence covers `38` getbbox cases (run `migration-coverage-a86591ac33d34cb896edce4586f7fefe`).
