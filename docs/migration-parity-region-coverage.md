...
coverage_run_id: migration-coverage-627c55a254ad4c61ae162559e0b7ccaf
...
`PIL.Image.Image.getbbox -> region coverage 4671/6983 (66.9%)`
...
| `PIL.ImageSequence.Iterator` | `image-sequence` | 2110/3359 | 62.8% |
...
| `PIL.Image.Image.alpha_composite` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.apply_transparency` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.close` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.convert` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.copy` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.crop` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.draft` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.effect_spread` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.entropy` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.filter` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.format` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.frombytes` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.get_child_images` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.get_flattened_data` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.getbands` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.getbbox` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.getchannel` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.getcolors` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.getdata` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.getexif` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.getextrema` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.getim` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.getpalette` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.getpixel` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.getprojection` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.getxmp` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.height` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.histogram` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.info` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.load` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.mode` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.paste` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.point` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.putalpha` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.putdata` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.putpalette` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.putpixel` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.quantize` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.reduce` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.remap_palette` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.resize` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.rotate` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.save` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.seek` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.show` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.size` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.split` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.tell` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.thumbnail` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.tobitmap` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.tobytes` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.toqimage` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.toqpixmap` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.transform` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.transpose` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.verify` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.Image.width` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.alpha_composite` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.blend` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.composite` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.effect_mandelbrot` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.effect_noise` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.eval` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.fromarray` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.frombuffer` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.frombytes` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.linear_gradient` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.merge` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.new` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.open` | `image-core` | 4671/6983 | 66.9% |
| `PIL.Image.radial_gradient` | `image-core` | 4671/6983 | 66.9% |
...
| `image-core` | `pillow-rs/src/image.rs` | 2110/3359 | 62.8% |
...
| `image-core` | `pillow-rs/src/pipeline.rs` | 30/38 | 78.9% |
...
| `image-sequence` | `pillow-rs/src/image.rs` | 2110/3359 | 62.8% |
