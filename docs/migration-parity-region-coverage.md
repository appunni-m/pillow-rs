...
coverage_run_id: migration-coverage-d04f1251ea8644cd8aeb41de177a997d
...
Component aggregate for backlog ordering: `10074/11120` (90.6%).
...
| `PIL.Image.Image.alpha_composite` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.apply_transparency` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.close` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.convert` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.copy` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.crop` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.draft` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.effect_spread` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.entropy` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.filter` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.format` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.frombytes` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.get_child_images` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.get_flattened_data` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.getbands` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.getbbox` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.getchannel` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.getcolors` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.getdata` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.getexif` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.getextrema` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.getim` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.getpalette` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.getpixel` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.getprojection` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.getxmp` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.height` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.histogram` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.info` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.load` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.mode` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.paste` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.point` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.putalpha` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.putdata` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.putpalette` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.putpixel` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.quantize` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.reduce` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.remap_palette` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.resize` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.rotate` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.save` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.seek` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.size` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.split` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.tell` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.thumbnail` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.tobitmap` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.tobytes` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.toqimage` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.toqpixmap` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.transform` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.transpose` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.verify` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.Image.width` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.alpha_composite` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.blend` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.composite` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.effect_mandelbrot` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.effect_noise` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.eval` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.fromarray` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.frombuffer` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.frombytes` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.linear_gradient` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.merge` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.new` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.open` | `image-core` | 10074/11120 | 90.6% |
| `PIL.Image.radial_gradient` | `image-core` | 10074/11120 | 90.6% |
