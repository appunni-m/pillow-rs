...
coverage_run_id: migration-coverage-afc009eb464b4e739b2b3eafbf310090
...
Scoped input-only evidence covers `38` getbbox cases (run `migration-coverage-9f7ede4398484b0fbdaaad4569892f8b`).
