...
- Node: **10952 executed**, 10952 passed, 0 failed, 0 pending, 0 infrastructure errors
- Browser: **10952 executed**, 10952 passed, 0 failed, 0 pending, 0 infrastructure errors
...
| `target_error` | 0 | Target reached a public error path whose class/message/result differs; fix boundary validation or core error parity. |
...
| `workflow_dependency_not_run` | 0 | A later observation was blocked by an earlier target failure; fix the first target error, not the dependent observation. |
