...
- Node: **10952 executed**, 10846 passed, 106 failed, 0 pending, 0 infrastructure errors
- Browser: **10952 executed**, 10846 passed, 106 failed, 0 pending, 0 infrastructure errors
...
| --- | ---: | --- |
| `result_mismatch` | 30 | Completed target result differs; fix core behavior or metadata, keeping bindings thin. |
| `target_error` | 62 | Target reached a public error path whose class/message/result differs; fix boundary validation or core error parity. |
...
| 2 | `PIL.Image.open` | 13 |
| 3 | `PIL.Image.Image.paste` | 12 |
| 4 | `PIL.Image.fromarray` | 7 |
| 5 | `PIL.Image.Image.info` | 6 |
| 6 | `PIL.ImageOps.equalize` | 5 |
| 7 | `PIL.Image.Image.entropy` | 4 |
| 8 | `PIL.Image.Image.has_transparency_data` | 4 |
| 9 | `PIL.ImageSequence.Iterator` | 4 |
| 10 | `PIL.Image.merge` | 3 |
| 11 | `PIL.Image.Image.filter` | 2 |
| 12 | `PIL.Image.Image.frombytes` | 2 |
| 13 | `PIL.Image.Image.getxmp` | 2 |
| 14 | `PIL.Image.Image.transpose` | 2 |
| 15 | `PIL.ImageDraw.Draw` | 2 |
| 16 | `PIL.ImageFilter.Kernel` | 2 |
| 17 | `PIL.ImageOps.deform` | 2 |
| 18 | `PIL.ImageOps.fit` | 2 |
| 19 | `PIL.ImageSequence.Iterator.__next__` | 2 |
| 20 | `PIL.Image.effect_mandelbrot` | 1 |
| 21 | `PIL.Image.frombuffer` | 1 |
| 22 | `PIL.Image.frombytes` | 1 |
| 23 | `PIL.Image.Image.convert` | 1 |
| 24 | `PIL.Image.Image.getim` | 1 |
| 25 | `PIL.Image.Image.tobytes` | 1 |
| 26 | `PIL.Image.Image.toqimage` | 1 |
| 27 | `PIL.Image.Image.toqpixmap` | 1 |
| 28 | `PIL.ImageDraw.Outline` | 1 |
| 29 | `PIL.ImageDraw.ImageDraw.getfont` | 1 |
| 30 | `PIL.ImageEnhance.Sharpness` | 1 |
| 31 | `PIL.ImageEnhance.Sharpness.enhance` | 1 |
| 32 | `PIL.ImageFilter.BoxBlur` | 1 |
| 33 | `PIL.ImageOps.pad` | 1 |
| 34 | `PIL.ImageSequence.Iterator.__iter__` | 1 |
| 35 | `PIL.ImageStat.Stat` | 1 |
