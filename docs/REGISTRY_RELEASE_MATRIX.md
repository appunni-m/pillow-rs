...
| fontdone | `fontdone` | `2.14.3-alpha.1` | crates.io | before `pillow-rs` | local tag commit `11e31c621000b0d2e6b93419d2022639cd92f0d5`; 20,354/20,354 runnable parity cases, CI, package, C SDK, and npm gates pass; cross-platform contract and reviewed benchmark thresholds remain external gates |
