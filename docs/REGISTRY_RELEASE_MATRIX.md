...
| --- | --- | --- | --- | --- | --- |
| image-slash-star | `image-slash-star` | `0.1.0` | crates.io | independent; before `pillow-rs` | remote `main` remains at `53a86b7e5748650d91adcda9dc7dc29d4fe7fe39` and retains the historical AV1 blobs rejected by GitHub; the clean-history release branch `codex/release-image-slash-star-clean-current` is now pushed at `4c47b587`, while the earlier ARM64 candidate `codex/release-ci-arm64-clean` remains at `13d8d7176d8b6e0d01974e4187dfa438ce72f7ee`; the current package archive at `be4918b0a9677f61c5e6623208e9afe9f40bf719` passed package, cross-target, doctest, and clean-consumer verification with SHA-256 `6d98579356a07600ca28a1b869dcb91ba0ac52234f36fbff84dede4f6c492cbd`; no `v0.1.0` registry publication has been made; strict source coverage remains an explicit release blocker at 95,603/161,451 lines |
...
`4c47b587`; its local verifier and package consumer pass, while the strict
source-coverage gate remains open. No `v0.1.0`
