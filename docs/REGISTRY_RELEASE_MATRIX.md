...
| fontdone | `fontdone` | `2.14.3-alpha.2` | crates.io | before `pillow-rs` | immutable local tag commit `ec58b10c29fae9b9ca4c622568bc1410596608fd`; the current pushed `main` commit `d63b3ce1a0b68cada1871bc1ddaffc91ed15b8ab` contains the sbix error-parity and image-cache input fixes with refreshed source-bound evidence (20,355/20,355 runnable cases, 3 safety-extension cases pending), while hosted fast/MSRV CI still covers the prior commit `50a1d7eec2b996cc394512dd39a3318629a61e2f`; the generated C-ABI scorecard is 6/12 with unresolved debt (C01.1 176/218, C01.7 13,572/18,098, C06.1 22/23, C07.1 19/20, C08.2 2,652/3,745, C08.3 15,829/20,355), five fresh platform bundles including the Windows import library, and benchmark review still required |
...
`d63b3ce1a0b68cada1871bc1ddaffc91ed15b8ab`; its immutable local release tag
