...
| fontdone | `fontdone` | `2.14.3-alpha.1` | crates.io | before `pillow-rs` | local tag commit `5702a6e53c4d7a4f35bf5a8959c73ef8a30979ca`; 20,354/20,354 runnable parity cases, CI, package, C SDK, and npm gates pass; cross-platform contract and reviewed benchmark thresholds remain external gates |
