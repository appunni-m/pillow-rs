...
Rust commit reviewed: `97a78f48d4fcc99c04f99e330140a5b67ca339f3`

Coverage MCP run: `f2adbe02-2ce4-4252-9baa-711afaa0cb37`

Coverage MCP snapshot: `f1371276-ca02-4349-bfd2-087d1bbfe322`
...
- Coverage MCP command `font-tests-coverage-with-freetype-pillow-12-2` passes on commit `97a78f48d4fcc99c04f99e330140a5b67ca339f3` and ingests snapshot `f1371276-ca02-4349-bfd2-087d1bbfe322`.
...
|---|---:|---:|---:|---:|---|
| `pillow-rs-freetype/src/ffi/handles.rs` | 1498/8960 16.72% | 148/2149 6.89% | 130/607 21.42% | 1919/12193 15.74% | high; includes public FreeType object/lifetime/stroker wrappers under ImageFont |
