...
- 381 input-only rows execute.
- 381 rows match live Pillow 12.2.0 exactly.
...
The current implementation is good enough to trust the active 381-row Font fixture corpus.
