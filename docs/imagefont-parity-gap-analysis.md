...
Rust commit reviewed: `f3376f410145bc978757ee53fefe0e1befad8529`

Coverage MCP run: `efadc037-55cb-4e19-9303-cf0973b1cb92`

Coverage MCP snapshot: `0a88b6a1-f2a4-48e7-b802-a742a599e0b6`
...
- Coverage MCP command `font-tests-coverage-with-freetype-pillow-12-2` passes on commit `f3376f410145bc978757ee53fefe0e1befad8529` and ingests snapshot `0a88b6a1-f2a4-48e7-b802-a742a599e0b6`.
...
- The current BGRA SBIT fixture includes an alpha-zero pixel generated by `pillow-rs-freetype/scripts/build_sbit_fixtures.py`. Existing live-oracle `getmask`/`getmask2` rows now prove Pillow-compatible transparent color bitmap conversion, moving `imagingft.rs` from 1686 to 1687 covered lines and from 252 to 253 covered branches in the pre-libraqm-helper snapshot; the current post-stroker-runner snapshot reports equivalent behavior at 1686/1711 lines, 253/262 branch coverage, and 2621/2720 region coverage.
...
| `pillow-rs/src/font/imagingft.rs` | 1686/1711 98.54% | 253/262 96.56% | 165/176 93.75% | 2621/2720 96.36% | real partial branch gaps remain |

Overall snapshot totals for this suite:

- Lines: 16177/50819, 31.83%
- Branches: 2744/10774, 25.47%
- Functions: 1234/3612, 34.16%
- Regions: 23240/78680, 29.54%
...
Coverage MCP reports 16 relevant gaps in `pillow-rs/src/font/imagingft.rs`: 7 uncovered lines and 9 partial-branch lines. The previous `FT_Set_Named_Instance` success-propagation gap was resolved by making the returned FreeType status explicit before `check_ft_error(status)?`; the existing public named-instance fixture rows now cover that flow.
