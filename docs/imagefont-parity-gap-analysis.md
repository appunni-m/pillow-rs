...
- Current-head Coverage MCP command `font-tests-coverage-with-freetype-pillow-12-2`
  passed at commit `cf42ae0c4506ae6530dbe2c011826ec1042670f1` and ingested
  snapshot `da0600ad-8a8d-4387-bce0-c5bbfd36d163` from run
  `fe35229b-781f-4fe3-8913-590c5a6839a8`. Direct `imagingft.rs` coverage
