...
Rust commit reviewed: `d8d7d9576a11a8b3f3a56cc0f92293ceb04a18ae`

Coverage MCP run: `926917bc-49db-4ae2-ad96-346735eee467`

Coverage MCP snapshot: `ea53fe3c-571f-4056-acb8-44caa96fd88c`
...
- Coverage MCP command `font-tests-coverage-with-freetype-pillow-12-2` passes on commit `d8d7d9576a11a8b3f3a56cc0f92293ceb04a18ae` with the current BGRA invariant cleanup and ingests snapshot `ea53fe3c-571f-4056-acb8-44caa96fd88c`.
...
Coverage snapshot: `ea53fe3c-571f-4056-acb8-44caa96fd88c`.
...
| `pillow-rs/src/font/imagingft.rs` | 1687/1711 98.60% | 252/260 96.92% | 165/176 93.75% | 2621/2719 96.40% | real partial branch gaps remain |

Overall snapshot totals for this suite:

- Lines: 16441/50819, 32.35%
- Branches: 2790/10772, 25.90%
- Functions: 1243/3612, 34.41%
- Regions: 23596/78679, 29.99%
...
Coverage MCP reports 14 relevant gaps in `pillow-rs/src/font/imagingft.rs`: 6 uncovered lines and 8 partial-branch lines. The previous `FT_Set_Named_Instance` success-propagation gap was resolved by making the returned FreeType status explicit before `check_ft_error(status)?`; the existing public named-instance fixture rows now cover that flow. The previous BGRA short-buffer fallback gap was removed because lower SBIT decoding guarantees FreeType-shaped BGRA bitmap storage; malformed embedded bitmap tables must be rejected in `pillow-rs-freetype`, not hidden in `_imagingft` adapter code.
