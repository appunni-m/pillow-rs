...
The integrated source commit `b6f453cd1` (verified in isolation as
`86973443c` before cherry-pick) mirrors Pillow's public ordering and CPU
guards while keeping
